...
class Greeting extends ComponentDialog {
    ...
    async promptForNameStep(step) {
        ...
        if (!userProfile.name) {
            ...
            return await step.prompt(NAME_PROMPT, 'What is your name, dude?');
        } else {
            return await step.next();
        }
    }
    ...
    async greetUser(step) {
        ...
        await step.context.sendActivity(`Hi ${ userProfile.name }, from ${ userProfile.city }, nice to meet you dude!`);
